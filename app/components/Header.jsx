    ...
    <div className='w-11/12 max-w-3xl text-center h-screen mx-auto flex flex-col items-center justify-center gap-4'>
      ...
      <div className='flex flex-col sm:flex-row items-center gap-4 mt-4'>
        ...
        <motion.a
          ...
          whileInView={{ opacity: 1, y: 0 }}
          transition={{ duration: 0.6, delay: 1 }}
          href='/Shashank#Resume.pdf' download className='px-10 py-3 border rounded-full border-gray-500 flex items-center gap-2 bg-white dark:text-black'>my resume <Image src={assets.download_icon} alt='' className='w-4' /></motion.a>
      </div>
    </div>
  )
}
