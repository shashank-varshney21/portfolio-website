...
const Navbar = ({isDarkMode, setIsDarkMode}) => {
  ...
  return (
    <>
        ...
        <nav className={`w-full fixed px-5 lg:px-8 xl:px-[-8%] py-4 flex justify-between items-center z-50 ${isScroll ? "bg-white bg-opacity-50 backdrop-blur-lg shadow-sm dark:bg-[#11001F] dark:shadow-white/20" : "" }`}>
            <a href='#top'>
                <Image src={ isDarkMode ? assets.logo_dark1 : assets.logo1} alt='' className='w-28 cursor-pointer mr-14'/>
            </a>
            ...
            <div className='flex items-center gap-4'>
                ...
                <a href='https://www.linkedin.com/in/shashank495/' className='hidden lg:flex items-center gap-3 px-10 py-2.5 border border-gray-500 rounded-full ml-4 font-Ovo dark:border-white/50'>Contact <Image src={ isDarkMode ?assets.arrow_icon_dark : assets.arrow_icon} alt='' className='w-3'/></a>
