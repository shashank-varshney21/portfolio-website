...
const About = ({isDarkMode}) => {
  return (
    ...
    >
        ...
        <motion.div className='flex flex-col w-full md:flex-row items-center gap-20 my-20'
            initial={{ opacity: 0 }}
            whileInView={{ opacity: 1 }}
            ...
            >
                ...
                className='grid grid-cols-1 sm:grid-cols-3 gap-6 max-w-2xl'>
                    {infoList.map(({icon, iconDark, title, description}, index)=>(
                        ...
                        className='border-[0.5px] border-gray-400 rounded-xl p-6 cursor-pointer hover:bg-[#fcf4ff] hover:-translate-y-1 duration-500 hover:shadow-[4px_4px_0_#000] dark:border-white dark:hover:shadow-white dark:hover:bg-[#2a004a]/50' key={index}>
